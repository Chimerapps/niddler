...
#./gradlew :niddler-lib-base:publishToMavenLocal :niddler-lib-base-noop:publishToMavenLocal :niddler-lib-java:publishToMavenLocal :niddler-lib-java-noop:publishToMavenLocal :niddler-lib-android:publishToMavenLocal :niddler-lib-android-noop:publishToMavenLocal --no-daemon
